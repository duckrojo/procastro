...
import procastro
from procastro.astro import query_transit_ephemeris, find_time_for_altitude, moon_distance
...
class ExoPlanet:
    ...
    def set_target(self, target, magnitude=10, star_name='',
        ...
        ephemeris = procastro.astro.exoplanet.get_transit_ephemeris_file(target)
